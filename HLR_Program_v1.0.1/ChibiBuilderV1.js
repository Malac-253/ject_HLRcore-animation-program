            ...
            Char.UpperBody = {};
                ...
                Char.UpperBody.FullHead = {}
                    ...
                    Char.UpperBody.FullHead.Head = {}
                        ...
                        Char.UpperBody.FullHead.Head.data = {};
                            ...
                            Char.UpperBody.FullHead.Head.data.id = ("FullHead_"+Char.name);
                    ...
                    Char.UpperBody.FullHead.Eyes = {}
                        ...
                        Char.UpperBody.FullHead.Eyes.data = {};
                            Char.UpperBody.FullHead.Eyes.data.ver = 1
                            ...
                            Char.UpperBody.FullHead.Eyes.data.mcolo = {}
                                Char.UpperBody.FullHead.Eyes.data.mcolo.type = 1 // 1 = linearGradient , 2 = radialGradient , 3 = plain fill (color 1)
                                Char.UpperBody.FullHead.Eyes.data.mcolo.color1 = "#cc6ab1"
                                Char.UpperBody.FullHead.Eyes.data.mcolo.color2 = "#fdfeec"
                            Char.UpperBody.FullHead.Eyes.data.pcolo = {}
                                Char.UpperBody.FullHead.Eyes.data.pcolo.type = 2 // 1 = linearGradient , 2 = radialGradient , 3 = plain fill (color 1)
                                Char.UpperBody.FullHead.Eyes.data.pcolo.color1 = "#b178ff"
                                Char.UpperBody.FullHead.Eyes.data.pcolo.color2 = "#fccbf4"
                    ...
                    Char.UpperBody.FullHead.HairandAcc = {}
                        ...
                        Char.UpperBody.FullHead.HairandAcc.data = {};
                            ...
                            Char.UpperBody.FullHead.HairandAcc.data.fcolo = {}
                                Char.UpperBody.FullHead.HairandAcc.data.fcolo.type = 2  // 1 = linearGradient , 2 = radialGradient , 3 = plain fill (color 1), 4 = plain fill (color 2
                                Char.UpperBody.FullHead.HairandAcc.data.fcolo.color1 = "#298acd"
                                Char.UpperBody.FullHead.HairandAcc.data.fcolo.color2 = "#fccbf4"
                            Char.UpperBody.FullHead.HairandAcc.data.bcolo = {}
                                Char.UpperBody.FullHead.HairandAcc.data.bcolo.type = 2 // 1 = linearGradient , 2 = radialGradient , 3 = plain fill (color 1), 4 = plain fill (color 2),5 = same as front
                                Char.UpperBody.FullHead.HairandAcc.data.bcolo.color1 = "#298acd"
                                Char.UpperBody.FullHead.HairandAcc.data.bcolo.color2 = "#fccbf4"
                ...
                Char.UpperBody.ChestandArms = {}
                    ...
                    Char.UpperBody.ChestandArms.data = {};
                        Char.UpperBody.ChestandArms.data.ver = 1
...
//                .delay(200)
    ...
    //Function to make BodyParts elements
        ...
        function body_eyes(Outparent,bodyPartData,name){
            ...
            //Mid Eyes Color Gradient
            if((bodyPartData.data.mcolo.type)==1){
                element_linearGradient(bodyPartData.element,("midEyesColorGradient_"+name),0,0,0,100,0,bodyPartData.data.mcolo.color1,1,100,bodyPartData.data.mcolo.color2,1)
                //element_linearGradient(Outparent,id,x1,y1,x2,y2,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.mcolo.type)==2){
                element_radialGradient(bodyPartData.element,("midEyesColorGradient_"+name),0,bodyPartData.data.mcolo.color1,1,100,bodyPartData.data.mcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.mcolo.type)==3){
                element_radialGradient(bodyPartData.element,("midEyesColorGradient_"+name),0,bodyPartData.data.mcolo.color1,1,100,bodyPartData.data.mcolo.color1,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.mcolo.type)==4){
                element_radialGradient(bodyPartData.element,("midEyesColorGradient_"+name),0,bodyPartData.data.mcolo.color2,1,100,bodyPartData.data.mcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else{
                element_radialGradient(bodyPartData.element,("midEyesColorGradient_"+name),0,"Black",1,100,"Black",1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
                console.error("Char.UpperBody.FullHead.Eyes.data.mcolo.type was not 1,2,3,4")
            }
            
            //Pupil Eyes Color Gradient
            if((bodyPartData.data.pcolo.type)==1){
                element_linearGradient(bodyPartData.element,("pulEyesColorGradient_"+name),0,0,0,100,0,bodyPartData.data.pcolo.color1,1,100,bodyPartData.data.pcolo.color2,1)
                //element_linearGradient(Outparent,id,x1,y1,x2,y2,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.pcolo.type)==2){
                element_radialGradient(bodyPartData.element,("pulEyesColorGradient_"+name),0,bodyPartData.data.pcolo.color1,1,100,bodyPartData.data.pcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.pcolo.type)==3){
                element_radialGradient(bodyPartData.element,("pulEyesColorGradient_"+name),0,bodyPartData.data.pcolo.color1,1,100,bodyPartData.data.pcolo.color1,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.pcolo.type)==4){
                element_radialGradient(bodyPartData.element,("pulEyesColorGradient_"+name),0,bodyPartData.data.pcolo.color2,1,100,bodyPartData.data.pcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else{
                element_radialGradient(bodyPartData.element,("pulEyesColorGradient_"+name),0,"Black",1,100,"Black",1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
                console.error("Char.UpperBody.FullHead.Eyes.data.pcolo.type was not 1,2,3,4")
            }
            
            
                //element_group(Outparent,id,origX,origY,scalX,scalY,tranX,tranY,rotat)
                bodyPartData.LeftYEye.element = element_group(bodyPartData.element,("LeftYEyes_"+name),1600,3750,1,0.9,0,0,0)

                    //Make the Eyes
                    var point_X = "860"; var point_Y = "-2000";
                    element_polygon(bodyPartData.LeftYEye.element,("LeftYEyesPoly_"+name),EyesPolyPD(point_X,point_Y),-0.8,0.8,0,0,180,"White","Black",0)
                    //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)

                    element_ellipse(bodyPartData.LeftYEye.element,("LeftYEyeMElli_"+name),750,2000,300,390,"url(#midEyesColorGradient_"+name+")","black",35)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_ellipse(bodyPartData.LeftYEye.element,("LeftYEyeGElli_"+name),550,1900,120,90,"white","black",0)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_ellipse(bodyPartData.LeftYEye.element,("LeftYEyePElli_"+name),740,2000,130,190,"url(#pulEyesColorGradient_"+name+")","black",5)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_path(bodyPartData.LeftYEye.element,("LeftYEyeOutLine_"+name),EyesLinePD(point_X,point_Y),-0.8,0.8,0,0,180,"Black","Black",1)
                    //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)

                //element_group(Outparent,id,origX,origY,scalX,scalY,tranX,tranY,rotat)
                bodyPartData.RightEye.element = element_group(bodyPartData.element,("RightEyes_"+name),1600,3750,1,0.9,1500,0,0)

                    //Right eye looks fine not flipped, by the way

                    //Make the Eyes
                    var point_X = "860"; var point_Y = "-2000";
                    element_polygon(bodyPartData.RightEye.element,("RightEyesPoly_"+name),EyesPolyPD(point_X,point_Y),0.8,0.8,2000,0,180,"White","Black",0)
                    //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)

                    element_ellipse(bodyPartData.RightEye.element,("RightEyeMElli_"+name),770,2000,300,390,"url(#midEyesColorGradient_"+name+")","black",35)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_ellipse(bodyPartData.RightEye.element,("RightEyeGElli_"+name),570,1900,120,90,"white","black",0)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_ellipse(bodyPartData.RightEye.element,("RightEyePElli_"+name),740,2000,130,190,"url(#pulEyesColorGradient_"+name+")","black",5)
                    //element_ellipse(Outparent,id,cx,cy,rx,ry,fill,stroke,strokW)

                    element_path(bodyPartData.RightEye.element,("RightEyeOutLine_"+name),EyesLinePD(point_X,point_Y),0.8,0.8,2000,0,180,"Black","Black",1)
                    //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
        ...
        function body_hairandacc(Outparent,bodyPartData,name){
            ...
            //front Hair Color Gradient
            if((bodyPartData.data.fcolo.type)==1){
                element_linearGradient(bodyPartData.element,("fhairColorGradient_"+name),0,0,0,100,0,bodyPartData.data.fcolo.color1,1,100,bodyPartData.data.fcolo.color2,1)
                //element_linearGradient(Outparent,id,x1,y1,x2,y2,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.fcolo.type)==2){
                element_radialGradient(bodyPartData.element,("fhairColorGradient_"+name),0,bodyPartData.data.fcolo.color1,1,100,bodyPartData.data.fcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.fcolo.type)==3){
                element_radialGradient(bodyPartData.element,("fhairColorGradient_"+name),0,bodyPartData.data.fcolo.color1,1,100,bodyPartData.data.fcolo.color1,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.fcolo.type)==4){
                element_radialGradient(bodyPartData.element,("fhairColorGradient_"+name),0,bodyPartData.data.fcolo.color2,1,100,bodyPartData.data.fcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else{
                element_radialGradient(bodyPartData.element,("fhairColorGradient_"+name),0,"Black",1,100,"Black",1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
                console.error("Char.UpperBody.FullHead.HairandAcc.data.fcolo.type was not 1,2,3,4")
            }
            
            //Back Hair Color Gradient
            if((bodyPartData.data.bcolo.type)==1){
                element_linearGradient(bodyPartData.element,("bhairColorGradient_"+name),0,0,0,100,0,bodyPartData.data.bcolo.color1,1,100,bodyPartData.data.bcolo.color2,1)
                //element_linearGradient(Outparent,id,x1,y1,x2,y2,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.bcolo.type)==2){
                element_radialGradient(bodyPartData.element,("bhairColorGradient_"+name),0,bodyPartData.data.bcolo.color1,1,100,bodyPartData.data.bcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.bcolo.type)==3){
                element_radialGradient(bodyPartData.element,("bhairColorGradient_"+name),0,bodyPartData.data.bcolo.color1,1,100,bodyPartData.data.bcolo.color1,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.bcolo.type)==4){
                element_radialGradient(bodyPartData.element,("bhairColorGradient_"+name),0,bodyPartData.data.bcolo.color2,1,100,bodyPartData.data.bcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else if ((bodyPartData.data.bcolo.type)==5){
                element_radialGradient(bodyPartData.element,("bhairColorGradient_"+name),0,bodyPartData.data.fcolo.color1,1,100,bodyPartData.data.fcolo.color2,1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
            }else{
                element_radialGradient(bodyPartData.element,("bhairColorGradient_"+name),0,"Black",1,100,"Black",1)
                //element_radialGradientt(Outparent,id,ofst1,fill1,opac1,ofst2,fill2,opac2)
                console.error("Char.UpperBody.FullHead.HairandAcc.data.bcolo.type was not 1,2,3,4,5")
            }
                
            //element_group(Outparent,id,origX,origY,scalX,scalY,tranX,tranY,rotat)
            bodyPartData.BackHair.element = element_group(bodyPartData.element,("HairBack_"+name),1650,3750,1,1,0,90,0)
                    
                //Make the back Hair
                var point_X = "3795"; var point_Y = "600";
                element_polygon(bodyPartData.BackHair.element,("HairBackPoly_"+name),HairBackPolyPD(point_X,point_Y),-0.9,0.9,0,0,180,"url(#bhairColorGradient_"+name+")","Black",0)
                //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)

                //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_path(bodyPartData.BackHair.element,("HairBackOutLine_"+name),HairBackLinePD(point_X,point_Y),-0.9,0.9,0,0,180,"Black","Black",1)
    
    
                //Make the back Hair Addtional part1
                var point_X = "3695"; var point_Y = "300";
                //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_polygon(bodyPartData.BackHair.element,("HairBackA1Poly_"+name),HairBackA1PolyPD(point_X,point_Y),-0.9,0.9,0,0,180,"#f9cdd4","Black",0)
                 //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_path(bodyPartData.BackHair.element,("HairBackA1OutLine_"+name),HairBackA1LinePD(point_X,point_Y),-0.9,0.9,0,0,180,"Black","Black",1)
    
                //Make the back Hair Addtional part2
                var point_X = "-100"; var point_Y = "-100";
                //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_polygon(bodyPartData.BackHair.element,("HairBackA2Poly_"+name),HairBackA2PolyPD(point_X,point_Y),-0.9,0.9,0,0,180,"#f9cdd4","Black",0)
                 //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_path(bodyPartData.BackHair.element,("HairBackA2OutLine_"+name),HairBackA2LinePD(point_X,point_Y),-0.9,0.9,0,0,180,"Black","Black",1)
    
            
            //element_group(Outparent,id,origX,origY,scalX,scalY,tranX,tranY,rotat)
            bodyPartData.FrontHair.element = element_group(bodyPartData.element,("HairFront_"+name),1650,3750,1,1,-300,0,0)

                //Make the front Hair
                var point_X = "2450"; var point_Y = "0";
                //element_polygon(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)
                element_polygon(bodyPartData.FrontHair.element,("HairFrontPoly_"+name),HairFrontPolyPD(point_X,point_Y),-0.9,0.9,0,0,180,"url(#fhairColorGradient_"+name+")","Black",0)
                 //element_path(Outparent,id,point_text,scalX,scalY,tranX,tranY,rotat,fill,stroke,strokW)-
                element_path(bodyPartData.FrontHair.element,("HairFrontOutLine_"+name),HairFrontLinePD(point_X,point_Y),-0.9,0.9,0,0,180,"Black","Black",1)
        ...
        function body_UpperBody(Outparent,bodyPartData,name){
            ...
            bodyPartData.FullHead.element = element_group(Outparent,bodyPartData.FullHead.data.id,bodyPartData.FullHead.data.origX,
