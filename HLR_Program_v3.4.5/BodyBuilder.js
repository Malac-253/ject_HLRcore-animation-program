...
//Scene set up
    ...
    var GreenScreen = element_rect(FSTS,"GreenScreen",5000,5000,"#ffffff","Black",0,1,1,0,0,0) //00a8ff , 4cd137 ,ffffff
...
//Event Code
    ...
    if (Clip1){
        ...
        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"You don't know what goes on behind these eyes")
        await sleep(1000)
        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"You don't know the loneliness hidden inside")
        await sleep(1000)
        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"You don't know I wanna eat you up alive")
        await sleep(1000)       
    }
    ...
    if (Clip2){
        ...
        //Staring postions
        TO_Standby(mainGuy)
        back1.anim.resetMovetoOrigin(300,400)
        back1.anim.addTransform({dur:0,del:0,scalX:0.2,scalY:0.2,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        
        back2.anim.resetMovetoOrigin(600,350)
        back2.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        
        back5.anim.resetMovetoOrigin(900,300)
        back5.anim.addTransform({dur:0,del:0,scalX:-0.2,scalY:-0.2,tranX:0,
                                  tranY:0,skewX:0,skewY:0,rotat:00})
        
        back3.anim.resetMovetoOrigin(1200,350)
        back3.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:00,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        
        back4.anim.resetMovetoOrigin(1500,400)
        back4.anim.addTransform({dur:0,del:0,scalX:0.2,scalY:0.2,tranX:000,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        
        mainGirl.anim.resetMovetoOrigin(900,600)
        mainGirl.anim.addTransform({dur:0,del:0,scalX:0.4,scalY:0.4,tranX:000,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        ...
        await sleep(3000)
        multimouthSpeak([back1,back2,back3,back4,back5],
                              LipPath,gofor,delay,"Wild Wild Wild Wild Wild Wild Wild Wild Wild Wild Wild Wild Wild")
        
        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"Come and get to know me my type of wild")
        
        await sleep(3000)
        multimouthSpeak([back1,back2,back3,back4,back5],
                              LipPath,gofor,delay,"You Dry You Dry You Dry You Dry You Dry You Dry")
        
        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"I'm the kind that spins you and hangs you dry")
    ...
    if (Clip3){
        ...
        //Staring postions
        TO_Standby(mainGuy)
        mainGirl.anim.resetMovetoOrigin(1000,400)
        mainGirl.anim.addTransform({dur:0,del:0,scalX:0.8,scalY:0.8,tranX:000,
                                   tranY:0,skewX:0,skewY:0,rotat:00})
        TO_Standby(back1) 
        TO_Standby(back2)
        TO_Standby(back3)
        ...
        TO_Standby(back5)
         ...
         //start (move to)
        mainGirl.UpperBody.LeftY.Arm.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:60,ease:d3.easePoly.exponent(1)})   
        
        mainGirl.UpperBody.Right.Arm.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:-80})     
        Dance1(mainGirl,50)
    ...
    var Clip4 = true
    if (Clip4){
        d3.select("#GreenScreen")
            .attr("transform","scale(1,1) translate(-5000,0) rotate(0)")
        //Staring postions
        TO_Standby(mainGuy)
        back1.anim.resetMovetoOrigin(300,400)
        back1.anim.addTransform({dur:0,del:0,scalX:0.2,scalY:0.2,tranX:0,
        ...
        d3.select("#GreenScreen")
            ...
            .attr("style","fill:#4cd137;  stroke:Black;  stroke-width:0; ")
         //00a8ff , 4cd137 ,ffffff
        ...
        d3.select("#GreenScreen")
            .attr("transform","scale(1,1) translate(0,0) rotate(0)")
            .attr("style","fill:#00a8ff;  stroke:Black;  stroke-width:0; ")
         //00a8ff , 4cd137 ,ffffff
...
//        await mainGirl.anim.mouthSpeak(LipPath,gofor,delay,"I'm the kind that spins you and hangs you dry")
    ...
    async function Dance1Help(object){
        //start (move to)
        object.UpperBody.LeftY.Arm.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:60,ease:d3.easePoly.exponent(1)})   
        
        object.UpperBody.Right.Arm.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                   tranY:0,skewX:0,skewY:0,rotat:-80}) 
        
        object.UpperBody.anim.addTransform({dur:0,del:0,scalX:0,scalY:0,tranX:0,
                                       tranY:0,skewX:0,skewY:0,rotat:10})
    }
    
    async function Dance1(object,reps,muit){
        if (muit == undefined){muit = 3}
        //time
        var time = 299 * muit//300
        var easer = d3.easePoly.exponent(4)
        var sway = 20
        
        
        Dance1part1(object,reps)
        Dance1part2(object,reps)
        
        async function Dance1part1(object,reps){
            //Parts
            var right = object.UpperBody.Right
                var right_hand = right.Hand.anim
                var right_fore = right.Fore.anim
                var right_armm = right.Arm.anim    

            var leftY = object.UpperBody.LeftY
                var lefty_hand = leftY.Hand.anim
                var leftY_fore = leftY.Fore.anim
                var leftY_armm = leftY.Arm.anim 

            //movement  
            var Fore_Move1_P = {dur:time,del:0,scalX:0,scalY:0,tranX:0,tranY:0,skewX:0,skewY:0,rotat:+80}
            var Fore_Move1_N = {dur:time,del:0,scalX:0,scalY:0,tranX:0,tranY:0,skewX:0,skewY:0,rotat:-80}

            var Armm_Move1_P = {dur:time,del:0,scalX:0,scalY:+0.5,tranX:0,tranY:0,skewX:0,skewY:0,rotat:0}
            var Armm_Move1_N = {dur:time,del:0,scalX:0,scalY:-0.5,tranX:0,tranY:0,skewX:0,skewY:0,rotat:0}

            var Swtiching_arm_P = {dur:time/2,del:0,scalX:0,scalY:0,tranX:0,tranY:0,skewX:0,skewY:0,rotat:+20,ease:easer}
            var Swtiching_arm_N = {dur:time/2,del:0,scalX:0,scalY:0,tranX:0,tranY:0,skewX:0,skewY:0,rotat:-20,ease:easer}

            for (i = 0; i < reps; i++) {
            //right arm moverment 

                await right_fore.addTransform(Fore_Move1_N)
                await right_fore.addTransform(Fore_Move1_P)

                await right_armm.addTransform(Armm_Move1_N)
                await right_armm.addTransform(Armm_Move1_P)

                //Swtiching arm
                leftY_armm.addTransform(Swtiching_arm_P)   

                right_armm.addTransform(Swtiching_arm_P)     

                //leftY arm moverment 

                await leftY_fore.addTransform(Fore_Move1_P)
                await leftY_fore.addTransform(Fore_Move1_N)

                await leftY_armm.addTransform(Armm_Move1_N)
                await leftY_armm.addTransform(Armm_Move1_P)

                leftY_armm.addTransform(Swtiching_arm_N)   
                right_armm.addTransform(Swtiching_arm_N)
            }
        }
        
        async function Dance1part2(object,reps){
            for (i = 0; i < reps; i++) {
             await object.UpperBody.anim.addTransform({dur:time*2,del:0,scalX:0,scalY:0,tranX:0,
                                       tranY:0,skewX:0,skewY:0,rotat:-1*sway})   

//            await object.LowerBody.anim.addTransform({dur:time*2,del:0,scalX:0,scalY:0,tranX:0,
//                                       tranY:0,skewX:0,skewY:0,rotat:sway})   

//            mainGirl.UpperBody.Right.Arm.anim.addTransform({dur:500,del:0,scalX:0,scalY:0,tranX:0,
//                                   tranY:0,skewX:0,skewY:0,rotat:-40}) 
//            
            await object.UpperBody.anim.addTransform({dur:time*2,del:0,scalX:0,scalY:0,tranX:0,
                                       tranY:0,skewX:0,skewY:0,rotat:sway})   
...
//HelperEvent Code
    function TO_Standby(object){
        object.element.attr("transform","scale(1,1)  translate(-10000,0)  rotate(0) ");
    }
...
//Video Help fuctions
    function multimouthSpeak(array,LipPath,gofor,delay,text){
        return new Promise(async function(resolve, reject) {
            array.forEach(async function(item, index, array) {
                if (index == (array.length - 1)){
                await item.anim.mouthSpeak(LipPath,gofor,delay,text)
                }else{
                    item.anim.mouthSpeak(LipPath,gofor,delay,text)
                }
        ...
        function anim_Standard_data(part){
            ...
            animate.addTransform = function(input){
                return new Promise(async function(resolve, reject) {
                    ...
                    await sleep((input.dur+input.del)*1.000)
                    resolve()
                })
            }
            animate.moveTransform = function(input){
                return new Promise(async function(resolve, reject) {
                    ...
                    await sleep((input.dur+input.del)*0.001)
                    resolve()  
                })
            }
            ...
            animate.resetMovetoOrigin = function(originx,originy,op){
                ...
                //console.log(box)
                var mx = originx - box.x - box.width/2
                var my = originy - box.y - box.height/2
...
//                        }
    ...
    function BodyBuilder(FSTS,Char,testing){
        ...
        Char.UpperBody.Right.Fore.anim.resetOrigin((Char.UpperBody.Right.Fore.data.origX + 10),
                                                   (Char.UpperBody.Right.Fore.data.origY - 4.5))
        
        Char.UpperBody.LeftY.Fore.anim.resetOrigin((Char.UpperBody.LeftY.Fore.data.origX - 8),
                                                   (Char.UpperBody.LeftY.Fore.data.origY - 2))
        
        Char.UpperBody.Right.Arm.anim.resetOrigin((Char.UpperBody.Right.Arm.data.origX + 0),
                                                   (Char.UpperBody.Right.Arm.data.origY - 0))
        
        Char.UpperBody.LeftY.Arm.anim.resetOrigin((Char.UpperBody.LeftY.Arm.data.origX + 0),
                                                   (Char.UpperBody.LeftY.Arm.data.origY -9))
        ...
        Char.LowerBody.anim.resetOrigin((Char.LowerBody.data.origX + 30),
                                        (Char.LowerBody.data.origY - 7))
        
        Char.UpperBody.anim.resetOrigin((Char.UpperBody.data.origX - 10),
                                        (Char.UpperBody.data.origY + 90))
        
//        element_circle(Char.UpperBody.element,("Origin_Rotate_"+Char.UpperBody.data.id),(Char.UpperBody.data.origX),(Char.UpperBody.data.origY),10,"Red","Red",1,1,1,0,0,0)
